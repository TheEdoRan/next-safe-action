...
This is the old documentation, for version 2 of the library. If you want to check out the new documentation, [you can find it here](https://github.com/TheEdoRan/next-safe-action/blob/main/packages/next-safe-action/README.md).
