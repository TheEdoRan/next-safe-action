...
With TypeBox, you can either use `typeboxAdapter` or use [TypeMap](https://github.com/sinclairzx81/typemap) to make it Standard Schema compatible, removing the need to use an adapter.
