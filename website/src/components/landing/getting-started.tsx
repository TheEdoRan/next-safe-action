		...
		<div className="flex min-h-screen items-center justify-center flex-col">
			...
			<div className="flex gap-4 mt-10 flex-wrap items-center justify-center">
				<a
					...
					className="!no-underline hover:brightness-90 transition cursor-pointer rounded-lg mr-4 px-3 py-2 font-bold inline-flex items-center justify-center text-2xl bg-zinc-800 !text-zinc-100 w-64">
					Get started ➡️
				</a>
			</div>
		</div>
