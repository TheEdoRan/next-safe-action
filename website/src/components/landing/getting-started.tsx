export function GettingStarted() {
	return (
		<div className="relative bg-gradient-to-b from-zinc-50 to-white py-24 md:py-32 dark:from-zinc-900 dark:to-zinc-950">
			...
			<div className="relative px-5 md:px-10">
				<div className="mx-auto w-full max-w-4xl text-center">
					<h2 className="mb-8 inline-block bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-2xl font-bold text-transparent md:text-3xl lg:text-4xl dark:from-blue-400 dark:to-purple-400">
						Ready to get started?
					</h2>
					<p className="mx-auto mb-12 max-w-xl text-zinc-600 dark:text-zinc-400">
