...
export default {
	...
	themeConfig: {
		...
		announcementBar: {
			id: "banner_version_6",
			content:
				"You are viewing documentation for version 6 of the library. To access current stable version docs, visit the <a href='https://next-safe-action.dev'>main website</a>.",
